    ...
    <NuxtLayout name="main">
        <template #banner>
            <LayoutBannerBase image="/imgs/proteccion-datos/proteccion-datos-header.png">
                <h1 class="h1-banner">Protección de Datos Personales: <span class="font-weight-regular">Información relevante en materia de protección de datos personales</span></h1>
            </LayoutBannerBase>
        </template>
