    ...
    .mural--main {
        ...
        .mural--trayectoria {
            ...
            .mural--biografia {
                ...
                .mural--biografia_content {
                    display: flex;
                    flex-direction: column;
                    gap: 2.4rem;

                    .mural--biografia_content-title {
            ...
            .mural--reconocimientos {}
        }

        .mural--patrocinadores {
            display: flex;
            flex-direction: column;
            gap: 6rem;
            max-width: 1195px;
            ...
            .mural--patrocinadores-title {
                align-self: center;
                max-width: 790px;
                width: min(790px, 100%);
            }

            .mural--patrocinadores-fleximgs {
                display: inline-flex;
                padding-left: 3.673px;
                flex-wrap: wrap;
                justify-content: center;
                align-items: center;
                column-gap: 90.906px;
                ...
                .mural--patrocinadores-boximg {
                    display: inline-flex;
                    max-height: 95px;

                    .mural--patrocinadores-img {
                        max-width: 551px;
                        width: 100%;
                        object-fit: contain;
                    }
