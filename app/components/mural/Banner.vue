...
import { ImageScaleModal2 } from '@components/modal';
...
<template>
    <section class="mural--boxbanner" aria-labelledby="mural-title">
        ...
        <ImageScaleModal2 ref="modalRef" :img="getMuralPath('mural-banner.png')" class="mural--banner_modal"aria-label="Vista ampliada del mural IPICYT" />
    </section>
</template>
